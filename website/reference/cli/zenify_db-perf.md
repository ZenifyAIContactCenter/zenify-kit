---
title: zenify db-perf
---

[Lệnh CLI](/reference/cli/) / `zenify db-perf`

# `zenify db-perf`

Quét tĩnh một diff để tìm anti-pattern query DB, chia finding thành BLOCKING và ADVISORY.

## Cú pháp

```text
zenify db-perf [flags]
```
