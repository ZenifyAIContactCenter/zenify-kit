---
title: zenify release-note
---

[Lệnh CLI](/reference/cli/) / `zenify release-note`

# `zenify release-note`

Ghi một commit ghi chú release mang metadata rủi ro, để release report đọc sau.

## Cú pháp

```text
zenify release-note [flags]
```
