...
| `zenify route-log record` | Ghi một route record (JSON qua stdin), best-effort |
| `zenify route-log record-plan` | Đếm task và file trong plan, ghi record site=plan-metrics |
