---
title: zenify visual check
---

[Lệnh CLI](/reference/cli/) / `zenify visual check`

# `zenify visual check`

So ảnh chụp từng route với baseline, hoặc chụp lại baseline khi giao diện đổi có chủ ý.

## Cú pháp

```text
zenify visual check [flags]
```
