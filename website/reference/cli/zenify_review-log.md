---
title: zenify review-log
---

[Lệnh CLI](/reference/cli/) / `zenify review-log`

# `zenify review-log`

Xem tổng hợp các lần review của `/znf:review` đã ghi lại trên máy bạn.

## Cú pháp

```text
zenify review-log [flags]
```
