...
| Tên | Mô tả |
|---|---|
| [architect](./architect) | Solution architect chạy trước khi viết spec ở tầng architectural khi một gate cơ học fire (cross-repo, shared contract, contract mới, path critical); mô tả cách giải, không viết code, memo mười mục theo khuôn architect-memo. |
