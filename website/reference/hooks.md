...
| PreToolUse | `Read` | `zenify hooks-run read-guard` | Chặn Read file quá lớn (text \> 200 KB không có offset+limit, PDF không có pages, ảnh \> 300 KB) trước khi kết quả vào context |
