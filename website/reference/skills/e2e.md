...
[Skill](/reference/skills/) / `/znf:e2e`

# `/znf:e2e`

Quyết định và viết journey E2E Playwright chạy thật từ UI tới BE, khẳng định kết quả domain bằng API re-fetch, qua được `zenify e2e lint`.
