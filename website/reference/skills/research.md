...
[Skill](/reference/skills/) / `/znf:research`

# `/znf:research <question> [repo: <feature-repo>]`

Research có kiểm chứng: worker tìm và trích dẫn nguyên văn kèm URL đã fetch, một lượt haiku fetch lại mọi URL, kết quả ghi thành file trong docs/reference.
