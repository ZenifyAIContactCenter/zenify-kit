...
[Skill](/reference/skills/) / `/znf:discipline`

# `/znf:discipline`

Bộ quy tắc làm việc thường trực của kit: định tuyến theo blast radius, không bịa, verify trước khi báo xong, worktree cho mọi thay đổi, git safety.
