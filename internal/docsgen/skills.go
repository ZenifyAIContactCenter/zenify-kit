...
func GenSkills(znf, coding fs.FS) (Files, error) {
	...
	addSkill := func(fm Frontmatter, ns string) {
		...
		b.WriteString("<!-- Generated by zenify docs gen from the SKILL.md frontmatter embedded in the binary; the skill body is agent-read and not rendered. -->\n") //znf:allow-lang
	...
	for _, e := range agents {
		...
		p.WriteString("<!-- Generated by zenify docs gen from the agent frontmatter embedded in the binary. -->\n") //znf:allow-lang
