...
**PR title/body — machine prefix, human body.** English `type(scope):` prefix; description + body in the project's prose language + attribution. See `references/pr-message-language.md`.
